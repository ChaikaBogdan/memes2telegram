...
def test_get_post_pics():
    url = "https://joyreactor.cc/post/5601868"
    post_pics = get_post_pics(url)
    assert len(post_pics) == 6
    assert "img2.joyreactor.cc/pics/post/Fantasy" in post_pics[0]
